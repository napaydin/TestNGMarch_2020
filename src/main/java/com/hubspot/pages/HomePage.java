...
public class HomePage extends BasePage{
	...
	//locator
	//By header = By.xpath("//h1[@class='private-page__title']");//bu da sales dashboard icin ikiside ok
	By header =By.xpath("//h1[contains(text(),'Sales Dashboard')]");
	//navAccount-accountName
	...
	public HomePage(WebDriver driver){
		this.driver = driver;//initialize yapmak icin yapiyoruz
